...
@section('content')
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Solu</b>Here</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Leo D. Nuneza</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>put charts summary here</small>
      </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://adminlte.io">SoluHere</a>.</strong> All rights
    reserved.
  </footer>
</div>
@endsection
